...
class GoalController():
    ...
    def calcTargetPoint(self):
        ...
        # Inform user
        rospy.logwarn("New goal position : " +
                      str(self.goal_position.position.x) + " , " +
...
class MantisGymEnv():
    ...
    def __init__(self):
        ...
        # Connect to gazebo
        self.velPub = rospy.Publisher('/diffdrive/cmd_vel',
                                      Twist,
                                      queue_size=5)
    ...
    def getLaserData(self):
        ...
        '''
        try:
            laserData = rospy.wait_for_message('/mantis/base_scan',
                                               LaserScan,
                                               timeout=5)
            return laserData
        except Exception as e:
